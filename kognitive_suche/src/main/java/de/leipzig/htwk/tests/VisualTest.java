...
public class VisualTest {
  ...
  public TagObjectList getTags() {
    ...
    tags1.addurl(2,
        "http://denl.dict.cc/?s=Sigma+%CE%A3+%CF%83+%CF%82+C+%5Bgriechischer+Buchstabe%5D");
    ...
    tags3
        .addurl(4,
            "http://www.amazon.de/Sigma-Kamera-Foto-Elektronik/s?ie=UTF8&page=1&rh=n%3A571860%2Ck%3ASigma");
