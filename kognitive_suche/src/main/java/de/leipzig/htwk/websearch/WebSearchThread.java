...
public class WebSearchThread extends Thread {
  ...
  /**
   * Abgeleitet von Thread und ist somit einer der parallel auzuführenden Vorgänge. Hier sollten die
   * Funktion zum aufrufen der URL bishin zum herausfiltern der Tags aufgerufen werden!
   * 
  ...
  String[] setTags() {
    ...
    /**
     * @return Rückgabe wird später durch das entsprechende Objekt ersetzt Hier müssen ausserdem die
     *         Funktionen des CognitiveSearch mit eingebunden werden
     * 
     */
